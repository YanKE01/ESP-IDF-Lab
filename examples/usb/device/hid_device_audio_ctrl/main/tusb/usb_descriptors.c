...
static uint8_t const s_configuration_descriptor[] = {
    ...
    TUD_HID_DESCRIPTOR(ITF_NUM_HID, STRID_HID, HID_ITF_PROTOCOL_NONE, sizeof(s_hid_report_descriptor), EPNUM_HID_IN, CFG_TUD_HID_EP_BUFSIZE, HID_POLLING_INTERVAL),
};
...
static char const *s_string_descriptors[] = {
    ...
    [STRID_PRODUCT] = "TinyUSB HID Consumer Control",
    [STRID_SERIAL] = "123456",
    [STRID_HID] = "TinyUSB HID Consumer Control Interface",
};
